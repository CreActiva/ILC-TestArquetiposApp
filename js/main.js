const q = ['Cuando te diriges a las personas usas palabras:', '¿Con cuál de éstas palabras te identificas más?', 'Los contenido más comunes en tus temas de conversación son:', 'Cuando entablas una relación interpresonal tu comunicación tiene un estilo:', 'Te caracterizas por ser una persona:', '¿Con cuál de éstas descripciones te identificas más?', 'En conversaciones tu energía vocal es:', 'Tu velocidad al hablar es:', 'Tu expresión facial común es:', 'En el escenario de ventas, su mayor fotaleza es:', 'En actividades cotidianas te caracterizas por:', '¿Qué actitud asumes frente a los errores de los otros?', 'De tu partitcipación en un grupo, por lo general te interesa obtener:', 'Por lo general tu estado de animo es:', 'En tu casa o en la oficina eres:', 'Tu energía la orientas fundamentalmente en la vida a:', '¿Qué actitudes asumes en situaciones de conflicto?', 'En la negociación:', 'Cuando tomas decisiones te motiva:', 'En la negociación:', ];
...
for (var i = 1; i <= 20; i++) {
  ...
  var quest = '<div class="carousel-item" id="question' + i + '"><div class="card"><div class="card-header"><h3>Test de arquetipos de personalidad</h3></div><div class="card-body" ><div class="progress mx-auto"><div class="progress-bar" id="progress-bar' + i + '" role="progressbar" style="width: 0%" aria-valuenow="0" aria-valuemin="0" aria-valuemax="100">0%</div></div><br><h5 class="card-title">' + q[i - 1] + '</h5></div></div>';

  $('.carousel-inner form').append(quest);
...
function extra(a) {
    ...
    for (var i = 0; i <= 3; i++) {
      ...
      for(var i = 0; i <=3; i++){//Organizar arquetipos
    switch (arquetipos[i].id){
        case 1: 
          $('#0').val(arquetipos[i].result);
        break;
        case 2: 
          $('#1').val(arquetipos[i].result);
        break;
        case 3: 
          $('#2').val(arquetipos[i].result);
        break;
        case 4: 
          $('#3').val(arquetipos[i].result);
        break;
    }
  }
}
...
function result() {
  ...
  if (casos[0] == casos[3]) {
      ...
      $('#sub').append('<div class="carousel-item" id="question' + 21 + '"><div class="card"><div class="card-header"><h3>Test de arquetipos de personalidad</h3></div><div class="card-body" ><div class="progress mx-auto"><div class="progress-bar bg-warning" id="progress-bar' + 21 + '" role="progressbar" style="width: 100%" aria-valuenow="Pregunta final" aria-valuemin="0" aria-valuemax="100">Pregunta final</div></div><br><h5 class="card-title">' + 'Al salir con personas:' + '</h5><div class="custom-control custom-radio  mt-3" id="radio' + 21 + '' + arquetipos[0].id + '"><input type="radio" class="custom-control-input"  id="q[' + 21 + '' + arquetipos[0].id + ']" name="q[' + 21 + ']" value="' + arquetipos[0].id + '"><label class="custom-control-label"  for="q[' + 21 + '' + arquetipos[0].id + ']">' + arquetipos[0].extra + '</label></div><div class="custom-control custom-radio  mt-3" id="radio' + 21 + '' + arquetipos[3].id + '"><input type="radio" class="custom-control-input"  id="q[' + 21 + '' + arquetipos[3].id + ']" name="q[' + 21 + ']" value="' + arquetipos[3].id + '"><label class="custom-control-label"  for="q[' + 21 + '' + arquetipos[3].id + ']">' + arquetipos[3].extra + '</label></div><div class="custom-control custom-radio  mt-3" id="radio' + 21 + '' + arquetipos[2].id + '"><input type="radio" class="custom-control-input"  id="q[' + 21 + '' + arquetipos[2].id + ']" name="q[' + 21 + ']" value="' + arquetipos[2].id + '"><label class="custom-control-label"  for="q[' + 21 + '' + arquetipos[2].id + ']">' + arquetipos[2].extra + '</label></div><div class="custom-control custom-radio  mt-3" id="radio' + 21 + '' + arquetipos[1].id + '"><input type="radio" class="custom-control-input"  id="q[' + 21 + '' + arquetipos[1].id + ']" name="q[' + 21 + ']" value="' + arquetipos[1].id + '"><label class="custom-control-label"  for="q[' + 21 + '' + arquetipos[1].id + ']">' + arquetipos[1].extra + '</label></div><button type="submit" id="submit" class="btn btn-warning mt-5" style="color: white;" onclick="extra(arquetipos)">Mostrar Resultados</button></div>');
      ...
      $('#sub').append('<div class="carousel-item" id="question' + 21 + '"><div class="card"><div class="card-header"><h3>Test de arquetipos de personalidad</h3></div><div class="card-body" ><div class="progress mx-auto"><div class="progress-bar bg-warning" id="progress-bar' + 21 + '" role="progressbar" style="width: 100%" aria-valuenow="Pregunta final" aria-valuemin="0" aria-valuemax="100">Extra</div></div><br><h5 class="card-title">' + 'Al salir con personas:' + '</h5><div class="custom-control custom-radio  mt-3" id="radio' + 21 + '' + arquetipos[0].id + '"><input type="radio" class="custom-control-input"  id="q[' + 21 + '' + arquetipos[0].id + ']" name="q[' + 21 + ']" value="' + arquetipos[0].id + '"><label class="custom-control-label"  for="q[' + 21 + '' + arquetipos[0].id + ']">' + arquetipos[0].extra + '</label></div><div class="custom-control custom-radio mt-3" style="display:none;" id="radio' + 21 + '' + arquetipos[3].id + '"><input type="radio" class="custom-control-input"  id="q[' + 21 + '' + arquetipos[3].id + ']" name="q[' + 21 + ']" value="' + arquetipos[3].id + '"><label class="custom-control-label"  for="q[' + 21 + '' + arquetipos[3].id + ']">' + arquetipos[3].extra + '</label></div><div class="custom-control custom-radio  mt-3" id="radio' + 21 + '' + arquetipos[2].id + '"><input type="radio" class="custom-control-input"  id="q[' + 21 + '' + arquetipos[2].id + ']" name="q[' + 21 + ']" value="' + arquetipos[2].id + '"><label class="custom-control-label"  for="q[' + 21 + '' + arquetipos[2].id + ']">' + arquetipos[2].extra + '</label></div><div class="custom-control custom-radio  mt-3" id="radio' + 21 + '' + arquetipos[1].id + '"><input type="radio" class="custom-control-input"  id="q[' + 21 + '' + arquetipos[1].id + ']" name="q[' + 21 + ']" value="' + arquetipos[1].id + '"><label class="custom-control-label"  for="q[' + 21 + '' + arquetipos[1].id + ']">' + arquetipos[1].extra + '</label></div><button class="btn btn-warning mt-5" style="color: white;" onclick="extra(arquetipos)">Mostrar Resultados</button></div>');
      $('#question20').removeClass("active");
      $('#question21').addClass("active");
      $('#sub').submit(function(e){
         $(this).unbind('submit').submit()
      ...
      $('#sub').append('<div class="carousel-item" id="question' + 21 + '"><div class="card"><div class="card-header"><h3>Test de arquetipos de personalidad</h3></div><div class="card-body" ><div class="progress mx-auto"><div class="progress-bar bg-warning" id="progress-bar' + 21 + '" role="progressbar" style="width: 100%" aria-valuenow="Pregunta final" aria-valuemin="0" aria-valuemax="100">Extra</div></div><br><h5 class="card-title">' + 'Al salir con personas:' + '</h5><div class="custom-control custom-radio  mt-3" id="radio' + 21 + '' + arquetipos[0].id + '"><input type="radio" class="custom-control-input"  id="q[' + 21 + '' + arquetipos[0].id + ']" name="q[' + 21 + ']" value="' + arquetipos[0].id + '"><label class="custom-control-label"  for="q[' + 21 + '' + arquetipos[0].id + ']">' + arquetipos[0].extra + '</label></div><div class="custom-control custom-radio  mt-3" style="display:none;" id="radio' + 21 + '' + arquetipos[3].id + '"><input type="radio" class="custom-control-input"  id="q[' + 21 + '' + arquetipos[3].id + ']" name="q[' + 21 + ']" value="' + arquetipos[3].id + '"><label class="custom-control-label"  for="q[' + 21 + '' + arquetipos[3].id + ']">' + arquetipos[3].extra + '</label></div><div class="custom-control custom-radio  mt-3" style="display:none;" id="radio' + 21 + '' + arquetipos[2].id + '"><input type="radio" class="custom-control-input"  id="q[' + 21 + '' + arquetipos[2].id + ']" name="q[' + 21 + ']" value="' + arquetipos[2].id + '"><label class="custom-control-label"  for="q[' + 21 + '' + arquetipos[2].id + ']">' + arquetipos[2].extra + '</label></div><div class="custom-control custom-radio  mt-3" id="radio' + 21 + '' + arquetipos[1].id + '"><input type="radio" class="custom-control-input"  id="q[' + 21 + '' + arquetipos[1].id + ']" name="q[' + 21 + ']" value="' + arquetipos[1].id + '"><label class="custom-control-label"  for="q[' + 21 + '' + arquetipos[1].id + ']">' + arquetipos[1].extra + '</label></div><button onclick="extra(arquetipos)" class="btn btn-warning mt-5" style="color: white;">Mostrar Resultados</button></div>');
